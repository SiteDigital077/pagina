                                ...
                                <div class="block">
                                    ...
                                    {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm1', 'url' => array('gestion/paginas/crearpagina'))) }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                               {{Form::radio('nivel', '1', true)}}Menú<br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                {{Form::textarea('seguimiento', '', array('class' => 'form-control','placeholder'=>'Ingrese código Seguimiento google analytics'))}}
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                {{Form::textarea('pixel', '', array('class' => 'form-control','placeholder'=>'Ingrese pixel facebook'))}}
                                            </div>
                                        </div>
                                    ...
                                    {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm2', 'url' => array('gestion/paginas/crearpagina'))) }}
                                        ...
                                        {{Form::hidden('posti', '1', array('class' => 'form-control','placeholder'=>'Ingrese la descripción de la página'))}}
                                        ...
                                        <div class="form-group form-actions">
                                            <div class="col-md-9 col-md-offset-3">
                                                <button type="submit" class="btn btn-sm btn-primary"><i class="fa fa-angle-right"></i> Crear Página</button>
                                                <button type="reset" class="btn btn-sm btn-warning"><i class="fa fa-repeat"></i> Cancelar</button>
                                            </div>
                                        </div>
                                    {{ Form::close() }}
