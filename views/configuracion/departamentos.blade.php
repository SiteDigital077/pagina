                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                  <a href="<?=URL::to('gestion/municipios/');?>/{{ $departamentos->id }}"><span  id="tip" data-toggle="tooltip" data-placement="left" title="Ver Municipios" class="btn btn-warning"><i class="fa fa-eye"></i></span></a>
