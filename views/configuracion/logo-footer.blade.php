                                    ...
                                    {{ Form::open(array('files' => true,'method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('gestion/contenidos/crearlogofooter'))) }}                                         
                                       @foreach($plantilla as $plantilla)
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                             <input type="text" name="FilePath" readonly="readonly" onclick="openKCFinder(this)" value="{{$plantilla->logofooter}}" class="form-control" placeholder="Click Para Seleccionar Logo Footer" />
                                            </div>
                                        </div>
                                        @endforeach
