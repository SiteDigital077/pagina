    ...
    @if($status=='ok_update')
      <div class="alert alert-warning">
       <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
         <strong>Logo pie de página actualizado con éxito</strong> CMS ...
      </div>
    @endif
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <h2><strong>Logo</strong> pie de página</h2>
                                    </div>
                                         ...
                                         <div class="form-group">
                                          ...
                                          <div class="col-md-9">
                                           <div class="input-group">
                                            <input type="text" id="image_label" class="form-control" name="FilePath" placeholder="Seleccionar imagen" aria-label="Image" aria-describedby="button-image" value="{{$plantilla->logofooter}}">
