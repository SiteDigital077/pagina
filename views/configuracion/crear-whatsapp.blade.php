                                     ...
                                     @if($whatsapp->id == 1)
                                      <h6><b>Datos Generales</b></h6>
                                       ...
                                       <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input">Mensaje Bienvenida</label>
                                            <div class="col-md-9">
                                                {{Form::text('bienvenida', '', array('class' => 'form-control','placeholder'=>'Ingrese Departamento','required' => 'required'))}}
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input">Número</label>
                                            <div class="col-md-9">
                                                {{Form::text('numero', '', array('class' => 'form-control','placeholder'=>'Ingrese Departamento','required' => 'required'))}}
                                            </div>
                                        </div>

                                         <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input">Mensaje Principal</label>
                                            <div class="col-md-9">
                                                {{Form::text('principal', '', array('class' => 'form-control','placeholder'=>'Ingrese Departamento','required' => 'required'))}}
                                            </div>
                                        </div>

                                         <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input">Mensaje Secudnario</label>
                                            <div class="col-md-9">
                                                {{Form::text('secundario', '', array('class' => 'form-control','placeholder'=>'Ingrese Departamento','required' => 'required'))}}
                                            </div>
                                        </div>

                                         <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input">Llamado a la Acción</label>
                                            <div class="col-md-9">
                                                {{Form::text('llamado', '', array('class' => 'form-control','placeholder'=>'Ingrese Departamento','required' => 'required'))}}
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                          <label class="col-md-3 control-label" for="example-password-input">Imagen área</label>
                                          <div class="col-md-9">
                                           <div class="input-group">
