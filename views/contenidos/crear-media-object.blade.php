                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <h2><strong>Crear</strong> media object</h2>
                                    </div>
                                    ...
                                    <!-- Basic Form Elements Content -->
                                     {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('gestion/contenidos/creargrafico'))) }}
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                {{Form::text('contenidos', '', array('class' => 'form-control','placeholder'=>'Ingrese icono'))}}
                                            </div>
                                        </div>
                                     ...
                                     <div class="form-group">
                                         <label class="col-md-3 control-label" for="example-password-input">Imagen</label>
                                          <div class="col-md-9">
                                           <div class="input-group">
                                            ...
                                            <div class="col-md-9">
                                                 {{Form::text('video', '', array('class' => 'form-control','placeholder'=>'Ingrese descripción'))}}
                                            </div>
                                        </div>
                                        ...
                                        {{Form::hidden('tipo', 'media', array('class' => 'form-control'))}}
