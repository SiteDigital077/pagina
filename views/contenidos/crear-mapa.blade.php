                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <h2><strong>Crear</strong> mapa</h2>
                                    </div>
                                    ...
                                    <!-- Basic Form Elements Content -->
                                     {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('gestion/contenidos/creargrafico'))) }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                 {{Form::text('contenidos', '', array('class' => 'form-control','placeholder'=>'Ingrese coordenadas'))}}
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                {{Form::text('imageal', '', array('class' => 'form-control','placeholder'=>'Ingrese alto del mapa'))}}
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                          ...
                                          {{Form::hidden('tipo', 'mapa', array('class' => 'form-control'))}}
