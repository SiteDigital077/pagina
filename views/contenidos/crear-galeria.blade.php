                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <h2><strong>Crear</strong> galería</h2>
                                    </div>
                                    ...
                                    <!-- Basic Form Elements Content -->
                                     ...
                                     <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                 {{Form::text('contenido', '', array('class' => 'form-control','placeholder'=>'Ingrese descripción'))}}
                                            </div>
                                        </div>
                                        ...
                                        {{Form::hidden('tipo', 'galeriaimg', array('class' => 'form-control'))}}
