                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <h2><strong>Crear</strong> video responsive</h2>
                                    </div>
                                    ...
                                    {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('gestion/contenidos/creargrafico'))) }}
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                              {{Form::text('enlace', '' , array('class' => 'form-control','placeholder'=>'Ingrese su Contraseña','placeholder'=>'Ingrese URL video'))}}
                                            </div>
                                        </div>
                                      ...
                                      {{Form::hidden('tipo', 'responsive', array('class' => 'form-control'))}}
