                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <h2><strong>Crear</strong> video background</h2>
                                    </div>
                                    ...
                                    {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('gestion/contenidos/creargrafico'))) }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                 {{Form::text('FilePath', '', array('class' => 'form-control','placeholder'=>'Ingrese descripción'))}}
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                 {{Form::text('imageal', '', array('class' => 'form-control','placeholder'=>'Ingrese descripción'))}}
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                 {{Form::text('enlace', '' , array('class' => 'form-control','placeholder'=>'Ingrese height video '))}}<br>
                                            </div>
                                        </div>
                                        ...
                                        {{Form::hidden('tipo', 'vimeoback', array('class' => 'form-control'))}}
                                        {{Form::hidden('num', '2', array('class' => 'form-control'))}}
