                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <h2><strong>Crear</strong> backimage</h2>
                                    </div>
                                    ...
                                    <!-- Basic Form Elements Content -->
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                 {{Form::text('imageal', '', array('class' => 'form-control','placeholder'=>'Ingrese Tamaño'))}}
                                            </div>
                                        </div>
                                        ...
                                        {{Form::hidden('tipo', 'backimage', array('class' => 'form-control'))}}
