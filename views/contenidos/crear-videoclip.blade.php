                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <h2><strong>Crear</strong> video clip</h2>
                                    </div>
                                    ...
                                    <!-- Basic Form Elements Content -->
                                      {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('gestion/contenidos/creargrafico'))) }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                 {{Form::text('contenidos', '', array('class' => 'form-control','placeholder'=>'Ingrese descripción'))}}
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                          ...
                                          {{Form::hidden('tipo', 'video-modal', array('class' => 'form-control'))}}
