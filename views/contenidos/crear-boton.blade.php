                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <h2><strong>Crear</strong> botón</h2>
                                    </div>
                                    ...
                                    <!-- Basic Form Elements Content -->
                                     {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('gestion/contenidos/creargrafico'))) }}
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input">Ancho botón</label>
                                            <div class="col-md-9">
                                        ...
                                        <input type="text" name="template" value="{{$temp->template}}">
                                        @endforeach


                                           {{Form::hidden('tipo', 'boton', array('class' => 'form-control'))}}
