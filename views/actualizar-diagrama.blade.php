                                ...
                                <div class="block">
                                    ...
                                    {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('/gestion/contenidos/actualizardiagrama',$diagramas->id))) }}
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-1 control-label" for="example-text-input">PosicionSD01</label>
                                            <div class="col-md-5">
                                                 {{Form::text('posicionsd01',  $diagramas->posicionSD01, array('class' => 'form-control', 'placeholder'=>'Ingrese diagrama'))}}
                                            </div>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            <label class="col-md-1 control-label" for="example-text-input">PosicionSD02</label>
                                            <div class="col-md-5">
                                                 {{Form::text('posicionsd02',  $diagramas->posicionSD02, array('class' => 'form-control', 'placeholder'=>'Ingrese diagrama'))}}
                                            </div>
                                         ...
                                         <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            <label class="col-md-1 control-label" for="example-text-input">Bloque</label>
                                            <div class="col-md-5">
                                                 {{Form::text('bloque',  $diagramas->bloque, array('class' => 'form-control', 'placeholder'=>'Ingrese diagrama'))}}
                                            </div>
                                        </div>
                                         <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <label class="col-md-1 control-label" for="example-text-input">PosicionSD03</label>
                                            <div class="col-md-5">
                                                 {{Form::text('posicionsd03',  $diagramas->posicionSD03, array('class' => 'form-control', 'placeholder'=>'Ingrese diagrama'))}}
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            <label class="col-md-1 control-label" for="example-text-input">Bloque Blog</label>
                                            <div class="col-md-5">
                                                 {{Form::text('bloqueblog',  $diagramas->bloqueblog, array('class' => 'form-control', 'placeholder'=>'Ingrese diagrama'))}}
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-md-1 control-label" for="example-text-input">Bloque Ficha 01</label>
                                            <div class="col-md-5">
                                                 {{Form::text('bloqueficha1',  $diagramas->bloqueficha1, array('class' => 'form-control', 'placeholder'=>'Ingrese diagrama'))}}
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-md-1 control-label" for="example-text-input">Bloque Ficha 02</label>
                                            <div class="col-md-5">
                                                 {{Form::text('bloqueficha2',  $diagramas->bloqueficha2, array('class' => 'form-control', 'placeholder'=>'Ingrese diagrama'))}}
                                            </div>
                                        </div>
